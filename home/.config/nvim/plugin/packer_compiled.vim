...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lspsaga.nvim", "lspkind-nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "playground", "nvim-autopairs", "nvim-treesitter-refactor" },
  ...
  ["nvim-web-devicons"] = {
    after = { "nvim-bufferline.lua", "nvim-nonicons", "windline.nvim" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-frecency.nvim", "telescope-media-files.nvim" },
    only_config = true
  },
  ["texmagic.nvim"] = {
  ...
  ["xresources-nvim"] = {
    after = { "indent-blankline.nvim", "vim-smoothie", "nvim-bufferline.lua", "nvim-web-devicons", "windline.nvim" },
