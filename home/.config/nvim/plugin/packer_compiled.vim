...
_G.packer_plugins = {
  ...
  ["pears.nvim"] = {
    ...
    loaded = true,
    path = "/home/atalariq/.local/share/nvim/site/pack/packer/start/pears.nvim"
  },
  ["plenary.nvim"] = {
    loaded = true,
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'glow.nvim', 'vim-markdown', 'vim-table-mode', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
