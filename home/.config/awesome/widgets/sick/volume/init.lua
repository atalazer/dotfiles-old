...
local volume_off  = HOME .. "/.config/awesome/widgets/sick/volume/volume_off.svg"
local volume_mute = HOME .. "/.config/awesome/widgets/sick/volume/volume_mute.svg"
local volume_low  = HOME .. "/.config/awesome/widgets/sick/volume/volume_down.svg"
local volume_high = HOME .. "/.config/awesome/widgets/sick/volume/volume_up.svg"
