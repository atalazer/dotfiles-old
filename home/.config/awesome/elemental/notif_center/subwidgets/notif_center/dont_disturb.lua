...
local PATH_TO_WIDGET = HOME .. "/.config/awesome/elemental/notif_center/subwidgets/notif_center/"
...
local dont_disturb_button = clickable_container(
    wibox.container.margin(dont_disturb_imagebox, dpi(7), dpi(7), dpi(7), dpi(7))
)
