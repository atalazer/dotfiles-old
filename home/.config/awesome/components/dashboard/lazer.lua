...
local font = RC.appearance.font_monospace or "monospace"
...
styles.header = {
    fg_color = color.color4,
    bg_color = color.color1 .. "00",
    -- markup   = function(t) return '<b>' .. t .. '</b>' end,
    markup = function(t)
        return "<span font_desc=\"".. font .. " bold 25\">" .. t .. "</span>"
    end,
}
styles.weekday = {
    fg_color = color.color6,
    bg_color = color.color1 .. "00",
    padding = 3,
    markup = function(t)
        return "<b>" .. t .. "</b>"
...
local a_text_widget = create_box(a_text, 200, 500, beautiful.bg_normal)
