...
local up       = os.getenv("HOME") .. "/.config/awesome/widgets/sick/netspeed/up.svg"
local down     = os.getenv("HOME") .. "/.config/awesome/widgets/sick/netspeed/down.svg"
local wlan_on  = os.getenv("HOME") .. "/.config/awesome/widgets/sick/netspeed/wifi_on.svg"
local wlan_off = os.getenv("HOME") .. "/.config/awesome/widgets/sick/netspeed/wifi_off.svg"
